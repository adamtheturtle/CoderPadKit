...
//  breakdown). Report PDFs live in MockScreen+ReportPDF.swift. Keys are the
...
nonisolated enum MockScreenFixtures {
    ...
    static func campaigns() -> [[String: Any]] {
        [
            ["id": 101, "name": "Backend Engineer", "product": "screen",
             "languages": ["python3", "go", "java"], "pinned": true, "archived": false],
            ["id": 102, "name": "Frontend Engineer", "product": "screen",
             "languages": ["javascript", "typescript"], "pinned": false, "archived": false],
            ["id": 103, "name": "Full-Stack Challenge", "product": "screen",
             "languages": ["python3", "javascript", "sql"], "pinned": false, "archived": false],
            ["id": 104, "name": "Data Science Screen", "product": "screen",
             "languages": ["python3", "r", "sql"], "pinned": false, "archived": false],
            ["id": 105, "name": "Legacy C++ Role (2023)", "product": "screen",
             "languages": ["cpp"], "pinned": false, "archived": true],
            ["id": 201, "name": "Map Skills Assessment", "product": "map",
             "languages": ["python3"], "pinned": false, "archived": false]
        ]
    }
    ...
    private nonisolated(unsafe) static let seedTests: [[String: Any]] =
        backendTests() + frontendTests() + fullStackTests() + dataScienceTests() + mapTests()
    ...
    private static func mapTests() -> [[String: Any]] {
        [
            session(id: 5401, campaign: 201, status: "completed", product: "map",
